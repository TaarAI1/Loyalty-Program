...
import {
  ...
  Gift, UserCog, LogOut, ChevronLeft, ChevronRight, Filter, ClipboardList, MessageSquare,
} from 'lucide-react';
  ...
  return (
    <aside className={cn(
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <div>
            <p className="font-black text-[15px] text-white leading-none tracking-tight">LoyaltyPlus</p>
